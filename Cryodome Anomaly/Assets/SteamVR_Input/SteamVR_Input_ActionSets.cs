...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_thumbstickVersion p_thumbstickVersion;
        ...
        public static SteamVR_Input_ActionSet_thumbstickVersion thumbstickVersion
        {
            get
            {
                return SteamVR_Actions.p_thumbstickVersion.GetCopy<SteamVR_Input_ActionSet_thumbstickVersion>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_thumbstickVersion = ((SteamVR_Input_ActionSet_thumbstickVersion)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_thumbstickVersion>("/actions/thumbstickVersion")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.thumbstickVersion};
        }
    }
}
